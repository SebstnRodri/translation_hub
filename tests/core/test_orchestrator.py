...
def test_orchestrator_run_with_untranslated_entries(mock_config, mock_file_handler, mock_service, mock_logger):
    """
...
def test_orchestrator_run_with_no_untranslated_entries(mock_config, mock_file_handler, mock_service, mock_logger):
    """
