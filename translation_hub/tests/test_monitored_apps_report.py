...
from translation_hub.translation_hub.report.monitored_apps_progress_report.monitored_apps_progress_report import execute
...
class TestMonitoredAppsReport(FrappeTestCase):
	def test_report_execution(self):
		...
		settings.append("monitored_apps", {
